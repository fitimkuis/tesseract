...
import static com.recognition.software.jdeskew.ImageUtil.setGrayscale;
...
public class TesseractTest {
    ...
    private static String path = dir.replace("\\", "/");
    ...
    public void testDoOCR_List_Rectangle() throws Exception {
        ...
        try {
            ...
            imageFile = new File(path+"/eurotext.pdf");
    ...
    public void testDoOCR_UNLV_Zone_File() throws Exception {
        ...
        File imageFile = new File(path+"/eurotext_unlv.png");
    ...
    public void testDoOCR_File_With_Configs() throws Exception {
        ...
        File imageFile = new File(path+"/eurotext.png");
    ...
    public void testDoOCR_File_Rectangle() throws Exception {
        ...
        File imageFile = new File(path+"/eurotext.bmp");
        //File imageFile = new File(path+"/demo.bmp");
    ...
    public void testDoOCR_PDF() throws Exception {
        logger.info("doOCR on a PDF document");
        File imageFile = new File(path+"/eurotext.pdf");
    ...
    public void testDoOCR_SkewedImage() throws Exception {
        ...
        File imageFile = new File(path+"/eurotext_deskew.png");
        BufferedImage bi = ImageIO.read(imageFile);
    ...
    public void testCreateDocuments() throws Exception {
        ...
        File imageFile1 = new File(path+"/eurotext.pdf");
        File imageFile2 = new File(path+"/eurotext.png");
    ...
    public void testGetWords() throws Exception {
        ...
        File imageFile = new File(path+"/eurotext.tif");
        String expResult = "The (quick) [brown] {fox} jumps!\nOver the $43,456.78 <lazy> #90 dog";
